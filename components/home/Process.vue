    ...
    <div class="bg-white shadow-lg rounded-xl overflow-hidden">
      ...
      <div v-if="isOpen" class="p-6 space-y-6 text-gray-700 text-[15px] leading-relaxed">
        ...
        <div>
          ...
          <p class="">
            The design phase bridges the gap between concept and reality. Our design team creates wireframes, mockups, and prototypes that visualize the final product. This stage includes User Experience (UX) Design, User Interface (UI) Design and prototyping.
          </p>
        </div>
        ...
        <div>
          ...
          <p class="">
            Inoxoft is committed to delivering a seamless user experience, and to ensure this, we implement rigorous quality assurance testing, leveraging a robust quality management system. Our QA engineers meticulously evaluate every aspect of the web product, conducting comprehensive tests to identify and resolve potential issues or bugs. As part of our custom web app development services, we also offer <a href="#" class="text-blue-600 underline">QA automation testing services</a> for both mobile and web applications.
          </p>
        </div>
